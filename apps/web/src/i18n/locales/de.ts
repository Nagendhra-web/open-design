...
export const de: Dict = {
  ...
  'critiqueTheater.roundLabel': 'Runde {round} von {total}',
  'critiqueTheater.ruleLineRunning': 'Wird versendet, wenn Komposit >= {threshold} und offene Pflichtfixes == 0. Andernfalls verfeinern, bis zu {max} Runden.',
  'critiqueTheater.ruleLineShipped': 'Versendet: Komposit {composite} >= Schwellenwert {threshold} mit 0 offenen Pflichtfixes. Konsens {consensus} von {total}.',
  'critiqueTheater.ruleLineInterrupted': 'Versandregel ({threshold} + 0 Pflichtfixes) nicht erfuellt, aber fruehzeitig gestoppt. Bestes von {n} behalten; Protokoll bleibt verfuegbar.',
  'critiqueTheater.density.active': 'Nur aktiv',
  'critiqueTheater.density.smart': 'Smart',
  'critiqueTheater.density.expanded': 'Alle ausklappen',
  'critiqueTheater.interrupt': 'Unterbrechen',
  'critiqueTheater.interrupting': 'Wird unterbrochen...',
  'critiqueTheater.interruptConfirmTitle': 'Jury stoppen?',
  'critiqueTheater.interruptConfirmBody': 'Das bisherige Beste der aktuellen Runde wird gespeichert.',
  'critiqueTheater.interruptConfirmYes': 'Stoppen',
  'critiqueTheater.interruptConfirmNo': 'Weitermachen',
  'critiqueTheater.replay.title': 'Transkript-Wiedergabe',
  'critiqueTheater.replay.readOnly': 'schreibgeschuetzt',
  'critiqueTheater.replay.speeds.1x': '1x',
  'critiqueTheater.replay.speeds.4x': '4x',
  'critiqueTheater.replay.speeds.instant': 'sofort',
  'critiqueTheater.degraded.title': 'Jury offline',
  'critiqueTheater.degraded.retry': 'Mit Jury erneut versuchen',
  'critiqueTheater.degraded.switchAdapter': 'Adapter wechseln',
  'critiqueTheater.degraded.readLog': 'Parser-Protokoll lesen',
  'critiqueTheater.shipped.score': 'Bewertung',
  'critiqueTheater.shipped.dimsLegend': 'Bewertungen pro Dimension',
  'critiqueTheater.shipped.export': 'Exportieren',
  'critiqueTheater.shipped.rerun': 'Jury wiederholen',
  'critiqueTheater.interrupted.title': 'Unterbrochen',
  'critiqueTheater.interrupted.resume': 'Fortsetzen',
  'critiqueTheater.interrupted.shipAsIs': 'Trotzdem so versenden',
  'critiqueTheater.interrupted.reBrief': 'Verwerfen, neu briefen',
  'critiqueTheater.panelist.designer': 'Designer',
  'critiqueTheater.panelist.critic': 'Kritiker',
