...
export const pl: Dict = {
  ...
  'critiqueTheater.roundLabel': 'runda {round} z {total}',
  'critiqueTheater.ruleLineRunning': 'Wysyłka, gdy kompozyt >= {threshold} i otwarte poprawki obowiązkowe == 0. W przeciwnym razie dopracowanie do {max} rund.',
  'critiqueTheater.ruleLineShipped': 'Wysłano: kompozyt {composite} >= próg {threshold} przy 0 otwartych poprawkach. Konsensus {consensus} z {total}.',
  'critiqueTheater.ruleLineInterrupted': 'Reguła wysyłki ({threshold} + 0 poprawek) nie spełniona, ale zatrzymano wcześniej. Najlepsze z {n} zachowane; transkrypt pozostaje dostępny.',
  'critiqueTheater.density.active': 'Tylko aktywne',
  'critiqueTheater.density.smart': 'Inteligentne',
  'critiqueTheater.density.expanded': 'Rozwiń wszystko',
  'critiqueTheater.interrupt': 'Przerwij',
  'critiqueTheater.interrupting': 'Przerywanie...',
  'critiqueTheater.interruptConfirmTitle': 'Zatrzymać jury?',
  'critiqueTheater.interruptConfirmBody': 'Najlepszy wynik bieżącej rundy zostanie zapisany.',
  'critiqueTheater.interruptConfirmYes': 'Zatrzymaj',
  'critiqueTheater.interruptConfirmNo': 'Kontynuuj',
  'critiqueTheater.replay.title': 'Odtwarzanie transkryptu',
  'critiqueTheater.replay.readOnly': 'tylko do odczytu',
  'critiqueTheater.replay.speeds.1x': '1x',
  'critiqueTheater.replay.speeds.4x': '4x',
  'critiqueTheater.replay.speeds.instant': 'natychmiastowe',
  'critiqueTheater.degraded.title': 'Jury offline',
  'critiqueTheater.degraded.retry': 'Ponów z jury',
  'critiqueTheater.degraded.switchAdapter': 'Zmień adapter',
  'critiqueTheater.degraded.readLog': 'Odczytaj dziennik parsera',
  'critiqueTheater.shipped.score': 'wynik',
  'critiqueTheater.shipped.dimsLegend': 'wyniki na wymiar',
  'critiqueTheater.shipped.export': 'eksportuj',
  'critiqueTheater.shipped.rerun': 'Uruchom jury ponownie',
  'critiqueTheater.interrupted.title': 'Przerwano',
  'critiqueTheater.interrupted.resume': 'Wznów',
  'critiqueTheater.interrupted.shipAsIs': 'Wyślij tak jak jest',
  'critiqueTheater.interrupted.reBrief': 'Odrzuc, nowe briefowanie',
  'critiqueTheater.panelist.designer': 'Projektant',
  'critiqueTheater.panelist.critic': 'Krytyk',
