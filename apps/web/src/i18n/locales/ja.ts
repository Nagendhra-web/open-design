...
export const ja: Dict = {
  ...
  'critiqueTheater.userFacingName': 'デザイン審査団',
  'critiqueTheater.roundLabel': 'ラウンド {round} / {total}',
  'critiqueTheater.ruleLineRunning': '合計スコア >= {threshold} かつ未解決の必須修正 == 0 で出荷。それ以外は最大 {max} ラウンドで改善。',
  'critiqueTheater.ruleLineShipped': '出荷済み: 合計 {composite} >= 閾値 {threshold}、未解決の必須修正 0 件。コンセンサス {consensus} / {total}。',
  'critiqueTheater.ruleLineInterrupted': '出荷条件 ({threshold} + 必須修正 0) 未達ですが、手動停止しました。{n} 回中の最良が保持され、トランスクリプトは引き続き利用可能です。',
  'critiqueTheater.density.active': 'アクティブのみ',
  'critiqueTheater.density.smart': 'スマート',
  'critiqueTheater.density.expanded': 'すべて展開',
  'critiqueTheater.interrupt': '中断',
  'critiqueTheater.interrupting': '中断中...',
  'critiqueTheater.interruptConfirmTitle': '審査を停止しますか?',
  'critiqueTheater.interruptConfirmBody': '現在のラウンドのベスト結果が保存されます。',
  'critiqueTheater.interruptConfirmYes': '停止',
  'critiqueTheater.interruptConfirmNo': '続ける',
  'critiqueTheater.replay.title': 'トランスクリプト再生',
  'critiqueTheater.replay.readOnly': '読み取り専用',
  'critiqueTheater.replay.speeds.1x': '1x',
  'critiqueTheater.replay.speeds.4x': '4x',
  'critiqueTheater.replay.speeds.instant': '即時',
  'critiqueTheater.degraded.title': '審査団オフライン',
  'critiqueTheater.degraded.retry': '審査団で再試行',
  'critiqueTheater.degraded.switchAdapter': 'アダプターを切替',
  'critiqueTheater.degraded.readLog': 'パーサーログを確認',
  'critiqueTheater.shipped.score': 'スコア',
  'critiqueTheater.shipped.dimsLegend': '次元別スコア',
  'critiqueTheater.shipped.export': 'エクスポート',
  'critiqueTheater.shipped.rerun': '審査団を再実行',
  'critiqueTheater.interrupted.title': '中断済み',
  'critiqueTheater.interrupted.resume': '再開',
  'critiqueTheater.interrupted.shipAsIs': 'このまま出荷',
  'critiqueTheater.interrupted.reBrief': '破棄して再ブリーフィング',
  'critiqueTheater.panelist.designer': 'デザイナー',
  'critiqueTheater.panelist.critic': '批評家',
