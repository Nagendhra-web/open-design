...
export const zhTW: Dict = {
  ...
  'critiqueTheater.roundLabel': '第 {round} / {total} 輪',
  'critiqueTheater.ruleLineRunning': '綜合分 >= {threshold} 且未解決必修項 == 0 時出稿。否則最多優化 {max} 輪。',
  'critiqueTheater.ruleLineShipped': '已出稿: 綜合分 {composite} >= 閾值 {threshold}，未解決必修項 0 條。共識 {consensus} / {total}。',
  'critiqueTheater.ruleLineInterrupted': '未滿足出稿規則 ({threshold} + 必修項 0)，但已提前終止。保留 {n} 輪中最優結果，記錄仍可查閱。',
  'critiqueTheater.density.active': '僅活躍',
  'critiqueTheater.density.smart': '智慧',
  'critiqueTheater.density.expanded': '全部展開',
  'critiqueTheater.interrupt': '中斷',
  'critiqueTheater.interrupting': '正在中斷...',
  'critiqueTheater.interruptConfirmTitle': '停止評審團?',
  'critiqueTheater.interruptConfirmBody': '目前輪次的最優結果將被保存。',
  'critiqueTheater.interruptConfirmYes': '停止',
  'critiqueTheater.interruptConfirmNo': '繼續',
  'critiqueTheater.replay.title': '記錄回放',
  'critiqueTheater.replay.readOnly': '唯讀',
  'critiqueTheater.replay.speeds.1x': '1x',
  'critiqueTheater.replay.speeds.4x': '4x',
  'critiqueTheater.replay.speeds.instant': '即時',
  'critiqueTheater.degraded.title': '評審團離線',
  'critiqueTheater.degraded.retry': '重新啟動評審團',
  'critiqueTheater.degraded.switchAdapter': '切換介面卡',
  'critiqueTheater.degraded.readLog': '查看解析日誌',
  'critiqueTheater.shipped.score': '得分',
  'critiqueTheater.shipped.dimsLegend': '各維度得分',
  'critiqueTheater.shipped.export': '匯出',
  'critiqueTheater.shipped.rerun': '重新執行評審團',
  'critiqueTheater.interrupted.title': '已中斷',
  'critiqueTheater.interrupted.resume': '恢復',
  'critiqueTheater.interrupted.shipAsIs': '直接出稿',
  'critiqueTheater.interrupted.reBrief': '捨棄並重新簡報',
  'critiqueTheater.panelist.designer': '設計師',
  'critiqueTheater.panelist.critic': '評論員',
