...
export const ar: Dict = {
  ...
  'critiqueTheater.userFacingName': 'هيئة التصميم',
  'critiqueTheater.roundLabel': 'الجولة {round} من {total}',
  'critiqueTheater.ruleLineRunning': 'يُرسل عندما يكون المركب >= {threshold} والإصلاحات الإلزامية المفتوحة == 0. وإلا يُصقّل حتى {max} جولات.',
  'critiqueTheater.ruleLineShipped': 'تم الإرسال: المركب {composite} >= العتبة {threshold} مع 0 إصلاحات مفتوحة. التوافق {consensus} من {total}.',
  'critiqueTheater.ruleLineInterrupted': 'لم تُستوفَ قاعدة الإرسال ({threshold} + 0 إصلاحات)، لكن توقفت مبكرًا. تم الاحتفاظ بالأفضل من {n}؛ يبقى النص متاحًا.',
  'critiqueTheater.density.active': 'النشط فقط',
  'critiqueTheater.density.smart': 'ذكي',
  'critiqueTheater.density.expanded': 'توسيع الكل',
  'critiqueTheater.interrupt': 'مقاطعة',
  'critiqueTheater.interrupting': 'جارٍ المقاطعة...',
  'critiqueTheater.interruptConfirmTitle': 'هل تريد إيقاف الهيئة؟',
  'critiqueTheater.interruptConfirmBody': 'سيتم حفظ أفضل نتيجة للجولة الحالية.',
  'critiqueTheater.interruptConfirmYes': 'إيقاف',
  'critiqueTheater.interruptConfirmNo': 'متابعة',
  'critiqueTheater.replay.title': 'إعادة تشغيل النص',
  'critiqueTheater.replay.readOnly': 'للقراءة فقط',
  'critiqueTheater.replay.speeds.1x': '1x',
  'critiqueTheater.replay.speeds.4x': '4x',
  'critiqueTheater.replay.speeds.instant': 'فوري',
  'critiqueTheater.degraded.title': 'الهيئة غير متصلة',
  'critiqueTheater.degraded.retry': 'إعادة المحاولة مع الهيئة',
  'critiqueTheater.degraded.switchAdapter': 'تبديل المحول',
  'critiqueTheater.degraded.readLog': 'قراءة سجل المحلل',
  'critiqueTheater.shipped.score': 'النتيجة',
  'critiqueTheater.shipped.dimsLegend': 'نتائج كل بُعد',
  'critiqueTheater.shipped.export': 'تصدير',
  'critiqueTheater.shipped.rerun': 'إعادة تشغيل الهيئة',
  'critiqueTheater.interrupted.title': 'تمت المقاطعة',
  'critiqueTheater.interrupted.resume': 'استئناف',
  'critiqueTheater.interrupted.shipAsIs': 'إرسال كما هو',
  'critiqueTheater.interrupted.reBrief': 'تجاهل وإعادة الإيجاز',
  'critiqueTheater.panelist.designer': 'مصمم',
  'critiqueTheater.panelist.critic': 'ناقد',
