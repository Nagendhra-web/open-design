...
export const ptBR: Dict = {
  ...
  'critiqueTheater.roundLabel': 'rodada {round} de {total}',
  'critiqueTheater.ruleLineRunning': 'Publicado quando o composto >= {threshold} e as correções obrigatórias abertas == 0. Caso contrário, refinamento até {max} rodadas.',
  'critiqueTheater.ruleLineShipped': 'Publicado: composto {composite} >= limiar {threshold} com 0 correções abertas. Consenso {consensus} de {total}.',
  'critiqueTheater.ruleLineInterrupted': 'A regra de publicação ({threshold} + 0 correções) não foi atendida, mas foi interrompido antecipadamente. O melhor de {n} foi mantido; a transcrição continua disponível.',
  'critiqueTheater.density.active': 'Apenas ativo',
  'critiqueTheater.density.smart': 'Inteligente',
  'critiqueTheater.density.expanded': 'Expandir tudo',
  'critiqueTheater.interrupt': 'Interromper',
  'critiqueTheater.interrupting': 'Interrompendo...',
  'critiqueTheater.interruptConfirmTitle': 'Parar o júri?',
  'critiqueTheater.interruptConfirmBody': 'O melhor resultado da rodada atual será salvo.',
  'critiqueTheater.interruptConfirmYes': 'Parar',
  'critiqueTheater.interruptConfirmNo': 'Continuar',
  'critiqueTheater.replay.title': 'Reprodução de transcrição',
  'critiqueTheater.replay.readOnly': 'somente leitura',
  'critiqueTheater.replay.speeds.1x': '1x',
  'critiqueTheater.replay.speeds.4x': '4x',
  'critiqueTheater.replay.speeds.instant': 'instantâneo',
  'critiqueTheater.degraded.title': 'Júri offline',
  'critiqueTheater.degraded.retry': 'Tentar novamente com o júri',
  'critiqueTheater.degraded.switchAdapter': 'Trocar adaptador',
  'critiqueTheater.degraded.readLog': 'Ler log do analisador',
  'critiqueTheater.shipped.score': 'pontuação',
  'critiqueTheater.shipped.dimsLegend': 'pontuações por dimensão',
  'critiqueTheater.shipped.export': 'exportar',
  'critiqueTheater.shipped.rerun': 'Executar júri novamente',
  'critiqueTheater.interrupted.title': 'Interrompido',
  'critiqueTheater.interrupted.resume': 'Retomar',
  'critiqueTheater.interrupted.shipAsIs': 'Publicar assim mesmo',
  'critiqueTheater.interrupted.reBrief': 'Descartar, re-briefing',
  'critiqueTheater.panelist.designer': 'Designer',
  'critiqueTheater.panelist.critic': 'Crítico',
