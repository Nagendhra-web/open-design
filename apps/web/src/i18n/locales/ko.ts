...
export const ko: Dict = {
  ...
  'critiqueTheater.userFacingName': '디자인 심사단',
  'critiqueTheater.roundLabel': '{round} / {total} 라운드',
  'critiqueTheater.ruleLineRunning': '종합 점수 >= {threshold} 이고 미해결 필수 수정 == 0 이면 출시. 그렇지 않으면 최대 {max} 라운드까지 개선합니다.',
  'critiqueTheater.ruleLineShipped': '출시 완료: 종합 {composite} >= 기준 {threshold}, 미해결 필수 수정 0건. 합의 {consensus} / {total}.',
  'critiqueTheater.ruleLineInterrupted': '출시 조건 ({threshold} + 필수 수정 0)을 충족하지 못했지만 일찍 중단했습니다. {n}회 중 최고 결과가 보존되며 트랜스크립트를 계속 이용할 수 있습니다.',
  'critiqueTheater.density.active': '활성만',
  'critiqueTheater.density.smart': '스마트',
  'critiqueTheater.density.expanded': '모두 펼치기',
  'critiqueTheater.interrupt': '중단',
  'critiqueTheater.interrupting': '중단 중...',
  'critiqueTheater.interruptConfirmTitle': '심사를 중단할까요?',
  'critiqueTheater.interruptConfirmBody': '현재 라운드의 최선 결과가 저장됩니다.',
  'critiqueTheater.interruptConfirmYes': '중단',
  'critiqueTheater.interruptConfirmNo': '계속하기',
  'critiqueTheater.replay.title': '트랜스크립트 재생',
  'critiqueTheater.replay.readOnly': '읽기 전용',
  'critiqueTheater.replay.speeds.1x': '1x',
  'critiqueTheater.replay.speeds.4x': '4x',
  'critiqueTheater.replay.speeds.instant': '즉시',
  'critiqueTheater.degraded.title': '심사단 오프라인',
  'critiqueTheater.degraded.retry': '심사단으로 재시도',
  'critiqueTheater.degraded.switchAdapter': '어댑터 전환',
  'critiqueTheater.degraded.readLog': '파서 로그 확인',
  'critiqueTheater.shipped.score': '점수',
  'critiqueTheater.shipped.dimsLegend': '차원별 점수',
  'critiqueTheater.shipped.export': '내보내기',
  'critiqueTheater.shipped.rerun': '심사단 재실행',
  'critiqueTheater.interrupted.title': '중단됨',
  'critiqueTheater.interrupted.resume': '재개',
  'critiqueTheater.interrupted.shipAsIs': '그대로 출시',
  'critiqueTheater.interrupted.reBrief': '폐기 후 재브리핑',
  'critiqueTheater.panelist.designer': '디자이너',
  'critiqueTheater.panelist.critic': '비평가',
