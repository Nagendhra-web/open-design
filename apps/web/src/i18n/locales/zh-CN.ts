...
export const zhCN: Dict = {
  ...
  'critiqueTheater.roundLabel': '第 {round} / {total} 轮',
  'critiqueTheater.ruleLineRunning': '综合分 >= {threshold} 且未解决的必修项 == 0 时出稿。否则最多优化 {max} 轮。',
  'critiqueTheater.ruleLineShipped': '已出稿: 综合分 {composite} >= 阈值 {threshold}，未解决必修项 0 条。共识 {consensus} / {total}。',
  'critiqueTheater.ruleLineInterrupted': '未满足出稿规则 ({threshold} + 必修项 0)，但已提前终止。保留 {n} 轮中最优结果，记录仍可查阅。',
  'critiqueTheater.density.active': '仅活跃',
  'critiqueTheater.density.smart': '智能',
  'critiqueTheater.density.expanded': '全部展开',
  'critiqueTheater.interrupt': '中断',
  'critiqueTheater.interrupting': '正在中断...',
  'critiqueTheater.interruptConfirmTitle': '停止评审团?',
  'critiqueTheater.interruptConfirmBody': '当前轮次的最优结果将被保存。',
  'critiqueTheater.interruptConfirmYes': '停止',
  'critiqueTheater.interruptConfirmNo': '继续',
  'critiqueTheater.replay.title': '记录回放',
  'critiqueTheater.replay.readOnly': '只读',
  'critiqueTheater.replay.speeds.1x': '1x',
  'critiqueTheater.replay.speeds.4x': '4x',
  'critiqueTheater.replay.speeds.instant': '即时',
  'critiqueTheater.degraded.title': '评审团离线',
  'critiqueTheater.degraded.retry': '重新启动评审团',
  'critiqueTheater.degraded.switchAdapter': '切换适配器',
  'critiqueTheater.degraded.readLog': '查看解析日志',
  'critiqueTheater.shipped.score': '得分',
  'critiqueTheater.shipped.dimsLegend': '各维度得分',
  'critiqueTheater.shipped.export': '导出',
  'critiqueTheater.shipped.rerun': '重新运行评审团',
  'critiqueTheater.interrupted.title': '已中断',
  'critiqueTheater.interrupted.resume': '恢复',
  'critiqueTheater.interrupted.shipAsIs': '直接出稿',
  'critiqueTheater.interrupted.reBrief': '丢弃并重新简报',
  'critiqueTheater.panelist.designer': '设计师',
  'critiqueTheater.panelist.critic': '评论员',
