...
export const en: Dict = {
  ...
  'critiqueTheater.roundLabel': 'round {round} of {total}',
  'critiqueTheater.ruleLineRunning': 'Ships when composite >= {threshold} and open must-fix == 0. Otherwise refine, up to {max} rounds.',
  'critiqueTheater.ruleLineShipped': 'Shipped: composite {composite} >= threshold {threshold} with 0 open must-fix. Consensus {consensus} of {total}.',
  'critiqueTheater.ruleLineInterrupted': 'Did not meet ship rule ({threshold} + 0 must-fix), but you stopped early. Best-of-{n} kept; transcript stays available.',
  'critiqueTheater.density.active': 'Active only',
  'critiqueTheater.density.smart': 'Smart',
  'critiqueTheater.density.expanded': 'Expand all',
  'critiqueTheater.interrupt': 'Interrupt',
  'critiqueTheater.interrupting': 'Interrupting...',
  'critiqueTheater.interruptConfirmTitle': 'Stop the jury?',
  'critiqueTheater.interruptConfirmBody': "The current round's best-so-far will be saved.",
  'critiqueTheater.interruptConfirmYes': 'Stop',
  'critiqueTheater.interruptConfirmNo': 'Keep going',
  'critiqueTheater.replay.title': 'Transcript replay',
  'critiqueTheater.replay.readOnly': 'read-only',
  'critiqueTheater.replay.speeds.1x': '1x',
  'critiqueTheater.replay.speeds.4x': '4x',
  'critiqueTheater.replay.speeds.instant': 'instant',
  'critiqueTheater.degraded.title': 'Jury offline',
  'critiqueTheater.degraded.retry': 'Retry with jury',
  'critiqueTheater.degraded.switchAdapter': 'Switch adapter',
  'critiqueTheater.degraded.readLog': 'Read parser log',
  'critiqueTheater.shipped.score': 'score',
  'critiqueTheater.shipped.dimsLegend': 'per-dimension scores',
  'critiqueTheater.shipped.export': 'export',
  'critiqueTheater.shipped.rerun': 'Re-run jury',
  'critiqueTheater.interrupted.title': 'Interrupted',
  'critiqueTheater.interrupted.resume': 'Resume',
  'critiqueTheater.interrupted.shipAsIs': 'Ship as-is anyway',
  'critiqueTheater.interrupted.reBrief': 'Discard, re-brief',
  'critiqueTheater.panelist.designer': 'Designer',
  'critiqueTheater.panelist.critic': 'Critic',
