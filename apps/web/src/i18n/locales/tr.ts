...
export const tr: Dict = {
  ...
  'critiqueTheater.userFacingName': 'Tasarim Jürisi',
  'critiqueTheater.roundLabel': '{round}. tur / {total}',
  'critiqueTheater.ruleLineRunning': 'Bileşik >= {threshold} ve açık zorunlu düzeltmeler == 0 olduğunda yayınlanır. Aksi halde {max} tura kadar iyileştirme yapılır.',
  'critiqueTheater.ruleLineShipped': 'Yayinlandi: bileşik {composite} >= eşik {threshold}, 0 açık düzeltme. Uzlaşı {consensus} / {total}.',
  'critiqueTheater.ruleLineInterrupted': 'Yayın kuralı ({threshold} + 0 düzeltme) karşılanmadı, ancak erken durduruldu. {n} içindeki en iyi saklandı; transkript mevcut kalmaya devam ediyor.',
  'critiqueTheater.density.active': 'Yalnızca aktif',
  'critiqueTheater.density.smart': 'Akıllı',
  'critiqueTheater.density.expanded': 'Tümünü genişlet',
  'critiqueTheater.interrupt': 'Kesintiye uğrat',
  'critiqueTheater.interrupting': 'Kesintiye uğratılıyor...',
  'critiqueTheater.interruptConfirmTitle': 'Jüri durdurulsun mu?',
  'critiqueTheater.interruptConfirmBody': 'Mevcut turun şimdiye kadarki en iyi sonucu kaydedilecek.',
  'critiqueTheater.interruptConfirmYes': 'Durdur',
  'critiqueTheater.interruptConfirmNo': 'Devam et',
  'critiqueTheater.replay.title': 'Transkript oynatma',
  'critiqueTheater.replay.readOnly': 'salt okunur',
  'critiqueTheater.replay.speeds.1x': '1x',
  'critiqueTheater.replay.speeds.4x': '4x',
  'critiqueTheater.replay.speeds.instant': 'anında',
  'critiqueTheater.degraded.title': 'Jüri çevrimdışı',
  'critiqueTheater.degraded.retry': 'Jüri ile yeniden dene',
  'critiqueTheater.degraded.switchAdapter': 'Adaptör değiştir',
  'critiqueTheater.degraded.readLog': 'Ayrıştırıcı günlüğünü oku',
  'critiqueTheater.shipped.score': 'puan',
  'critiqueTheater.shipped.dimsLegend': 'boyut bazlı puanlar',
  'critiqueTheater.shipped.export': 'dışa aktar',
  'critiqueTheater.shipped.rerun': 'Jüriyi yeniden çalıştır',
  'critiqueTheater.interrupted.title': 'Kesildi',
  'critiqueTheater.interrupted.resume': 'Devam et',
  'critiqueTheater.interrupted.shipAsIs': 'Olduğu gibi yayınla',
  'critiqueTheater.interrupted.reBrief': 'İptal et, yeniden brifintle',
  'critiqueTheater.panelist.designer': 'Tasarımcı',
  'critiqueTheater.panelist.critic': 'Eleştirmen',
