...
export const fa: Dict = {
  ...
  'critiqueTheater.userFacingName': 'هیئت طراحی',
  'critiqueTheater.roundLabel': 'دور {round} از {total}',
  'critiqueTheater.ruleLineRunning': 'زمانی ارسال می‌شود که مرکب >= {threshold} و اصلاحات اجباری باز == 0 باشد. در غیر این صورت تا {max} دور بهبود می‌یابد.',
  'critiqueTheater.ruleLineShipped': 'ارسال شد: مرکب {composite} >= آستانه {threshold} با 0 اصلاح باز. اجماع {consensus} از {total}.',
  'critiqueTheater.ruleLineInterrupted': 'قانون ارسال ({threshold} + 0 اصلاح) برآورده نشد، اما زود متوقف شد. بهترین از {n} نگه داشته شده، رونوشت در دسترس است.',
  'critiqueTheater.density.active': 'فقط فعال',
  'critiqueTheater.density.smart': 'هوشمند',
  'critiqueTheater.density.expanded': 'گسترش همه',
  'critiqueTheater.interrupt': 'قطع',
  'critiqueTheater.interrupting': 'در حال قطع...',
  'critiqueTheater.interruptConfirmTitle': 'هیئت متوقف شود؟',
  'critiqueTheater.interruptConfirmBody': 'بهترین نتیجه دور فعلی ذخیره خواهد شد.',
  'critiqueTheater.interruptConfirmYes': 'توقف',
  'critiqueTheater.interruptConfirmNo': 'ادامه',
  'critiqueTheater.replay.title': 'پخش مجدد رونوشت',
  'critiqueTheater.replay.readOnly': 'فقط خواندنی',
  'critiqueTheater.replay.speeds.1x': '1x',
  'critiqueTheater.replay.speeds.4x': '4x',
  'critiqueTheater.replay.speeds.instant': 'فوری',
  'critiqueTheater.degraded.title': 'هیئت آفلاین',
  'critiqueTheater.degraded.retry': 'تلاش مجدد با هیئت',
  'critiqueTheater.degraded.switchAdapter': 'تغییر آداپتور',
  'critiqueTheater.degraded.readLog': 'خواندن گزارش تجزیه‌گر',
  'critiqueTheater.shipped.score': 'نمره',
  'critiqueTheater.shipped.dimsLegend': 'نمرات هر بُعد',
  'critiqueTheater.shipped.export': 'صادر کردن',
  'critiqueTheater.shipped.rerun': 'اجرای مجدد هیئت',
  'critiqueTheater.interrupted.title': 'قطع شد',
  'critiqueTheater.interrupted.resume': 'ادامه',
  'critiqueTheater.interrupted.shipAsIs': 'همین‌طور ارسال',
  'critiqueTheater.interrupted.reBrief': 'دور انداختن و بریفینگ مجدد',
  'critiqueTheater.panelist.designer': 'طراح',
  'critiqueTheater.panelist.critic': 'منتقد',
