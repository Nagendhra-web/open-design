...
export const fr: Dict = {
  ...
  'settings.featuresHint': 'Capacités expérimentales',
  ...
  'critiqueTheater.roundLabel': 'tour {round} sur {total}',
  'critiqueTheater.ruleLineRunning': 'Publié quand le score composite >= {threshold} et les corrections obligatoires ouvertes == 0. Sinon, affinement jusqu\'à {max} tours.',
  'critiqueTheater.ruleLineShipped': 'Publié: composite {composite} >= seuil {threshold} avec 0 corrections obligatoires. Consensus {consensus} sur {total}.',
  'critiqueTheater.ruleLineInterrupted': 'La règle de publication ({threshold} + 0 corrections) n\'est pas satisfaite, mais vous avez arrete manuellement. Le meilleur de {n} est conserve; la transcription reste disponible.',
  'critiqueTheater.density.active': 'Actif seulement',
  'critiqueTheater.density.smart': 'Intelligent',
  'critiqueTheater.density.expanded': 'Tout developper',
  'critiqueTheater.interrupt': 'Interrompre',
  'critiqueTheater.interrupting': 'Interruption en cours...',
  'critiqueTheater.interruptConfirmTitle': 'Arreter le jury ?',
  'critiqueTheater.interruptConfirmBody': 'Le meilleur resultat du tour en cours sera sauvegarde.',
  'critiqueTheater.interruptConfirmYes': 'Arreter',
  'critiqueTheater.interruptConfirmNo': 'Continuer',
  'critiqueTheater.replay.title': 'Relecture de la transcription',
  'critiqueTheater.replay.readOnly': 'lecture seule',
  'critiqueTheater.replay.speeds.1x': '1x',
  'critiqueTheater.replay.speeds.4x': '4x',
  'critiqueTheater.replay.speeds.instant': 'instantane',
  'critiqueTheater.degraded.title': 'Jury hors ligne',
  'critiqueTheater.degraded.retry': 'Reessayer avec le jury',
  'critiqueTheater.degraded.switchAdapter': 'Changer d\'adaptateur',
  'critiqueTheater.degraded.readLog': 'Lire le journal de l\'analyseur',
  'critiqueTheater.shipped.score': 'score',
  'critiqueTheater.shipped.dimsLegend': 'scores par dimension',
  'critiqueTheater.shipped.export': 'exporter',
  'critiqueTheater.shipped.rerun': 'Relancer le jury',
  'critiqueTheater.interrupted.title': 'Interrompu',
  'critiqueTheater.interrupted.resume': 'Reprendre',
  'critiqueTheater.interrupted.shipAsIs': 'Publier tel quel',
  'critiqueTheater.interrupted.reBrief': 'Abandonner, rebriffer',
  'critiqueTheater.panelist.designer': 'Designer',
  'critiqueTheater.panelist.critic': 'Critique',
