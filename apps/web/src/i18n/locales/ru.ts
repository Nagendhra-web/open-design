...
export const ru: Dict = {
  ...
  'critiqueTheater.userFacingName': 'Жюри дизайна',
  'critiqueTheater.roundLabel': 'раунд {round} из {total}',
  'critiqueTheater.ruleLineRunning': 'Публикуется, когда сводный балл >= {threshold} и открытых обязательных правок == 0. Иначе доработка до {max} раундов.',
  'critiqueTheater.ruleLineShipped': 'Опубликовано: сводный {composite} >= порог {threshold} при 0 открытых правках. Консенсус {consensus} из {total}.',
  'critiqueTheater.ruleLineInterrupted': 'Правило публикации ({threshold} + 0 правок) не выполнено, но остановлено досрочно. Лучший из {n} сохранён, транскрипт доступен.',
  'critiqueTheater.density.active': 'Только активные',
  'critiqueTheater.density.smart': 'Умный',
  'critiqueTheater.density.expanded': 'Развернуть всё',
  'critiqueTheater.interrupt': 'Прервать',
  'critiqueTheater.interrupting': 'Прерывание...',
  'critiqueTheater.interruptConfirmTitle': 'Остановить жюри?',
  'critiqueTheater.interruptConfirmBody': 'Лучший результат текущего раунда будет сохранён.',
  'critiqueTheater.interruptConfirmYes': 'Остановить',
  'critiqueTheater.interruptConfirmNo': 'Продолжить',
  'critiqueTheater.replay.title': 'Воспроизведение транскрипта',
  'critiqueTheater.replay.readOnly': 'только чтение',
  'critiqueTheater.replay.speeds.1x': '1x',
  'critiqueTheater.replay.speeds.4x': '4x',
  'critiqueTheater.replay.speeds.instant': 'мгновенно',
  'critiqueTheater.degraded.title': 'Жюри не в сети',
  'critiqueTheater.degraded.retry': 'Повторить с жюри',
  'critiqueTheater.degraded.switchAdapter': 'Сменить адаптер',
  'critiqueTheater.degraded.readLog': 'Читать журнал парсера',
  'critiqueTheater.shipped.score': 'оценка',
  'critiqueTheater.shipped.dimsLegend': 'оценки по измерениям',
  'critiqueTheater.shipped.export': 'экспорт',
  'critiqueTheater.shipped.rerun': 'Запустить жюри снова',
  'critiqueTheater.interrupted.title': 'Прервано',
  'critiqueTheater.interrupted.resume': 'Возобновить',
  'critiqueTheater.interrupted.shipAsIs': 'Опубликовать как есть',
  'critiqueTheater.interrupted.reBrief': 'Отменить, новый брифинг',
  'critiqueTheater.panelist.designer': 'Дизайнер',
  'critiqueTheater.panelist.critic': 'Критик',
