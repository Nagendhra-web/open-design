...
export const esES: Dict = {
  ...
  'critiqueTheater.roundLabel': 'ronda {round} de {total}',
  'critiqueTheater.ruleLineRunning': 'Se publica cuando el compuesto >= {threshold} y las correcciones obligatorias abiertas == 0. De lo contrario, refinamiento hasta {max} rondas.',
  'critiqueTheater.ruleLineShipped': 'Publicado: compuesto {composite} >= umbral {threshold} con 0 correcciones abiertas. Consenso {consensus} de {total}.',
  'critiqueTheater.ruleLineInterrupted': 'No se cumplio la regla de publicacion ({threshold} + 0 correcciones), pero se detuvo antes. Se conserva el mejor de {n}; la transcripcion sigue disponible.',
  'critiqueTheater.density.active': 'Solo activo',
  'critiqueTheater.density.smart': 'Inteligente',
  'critiqueTheater.density.expanded': 'Expandir todo',
  'critiqueTheater.interrupt': 'Interrumpir',
  'critiqueTheater.interrupting': 'Interrumpiendo...',
  'critiqueTheater.interruptConfirmTitle': '¿Detener el jurado?',
  'critiqueTheater.interruptConfirmBody': 'Se guardara el mejor resultado del turno actual.',
  'critiqueTheater.interruptConfirmYes': 'Detener',
  'critiqueTheater.interruptConfirmNo': 'Continuar',
  'critiqueTheater.replay.title': 'Reproduccion de transcripcion',
  'critiqueTheater.replay.readOnly': 'solo lectura',
  'critiqueTheater.replay.speeds.1x': '1x',
  'critiqueTheater.replay.speeds.4x': '4x',
  'critiqueTheater.replay.speeds.instant': 'instantaneo',
  'critiqueTheater.degraded.title': 'Jurado sin conexion',
  'critiqueTheater.degraded.retry': 'Reintentar con jurado',
  'critiqueTheater.degraded.switchAdapter': 'Cambiar adaptador',
  'critiqueTheater.degraded.readLog': 'Leer registro del analizador',
  'critiqueTheater.shipped.score': 'puntuacion',
  'critiqueTheater.shipped.dimsLegend': 'puntuaciones por dimension',
  'critiqueTheater.shipped.export': 'exportar',
  'critiqueTheater.shipped.rerun': 'Volver a ejecutar jurado',
  'critiqueTheater.interrupted.title': 'Interrumpido',
  'critiqueTheater.interrupted.resume': 'Reanudar',
  'critiqueTheater.interrupted.shipAsIs': 'Publicar tal cual',
  'critiqueTheater.interrupted.reBrief': 'Descartar, re-briefing',
  'critiqueTheater.panelist.designer': 'Disenador',
  'critiqueTheater.panelist.critic': 'Critico',
