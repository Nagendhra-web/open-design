...
export const hu: Dict = {
  ...
  'critiqueTheater.userFacingName': 'Tervező zsűri',
  'critiqueTheater.roundLabel': '{round}. kör / {total}',
  'critiqueTheater.ruleLineRunning': 'Kiadás, ha a kompozit >= {threshold} és a nyitott kötelező javítások == 0. Egyébként finomítás, legfeljebb {max} körben.',
  'critiqueTheater.ruleLineShipped': 'Kiadva: kompozit {composite} >= küszöb {threshold}, 0 nyitott javítással. Konszenzus {consensus} / {total}.',
  'critiqueTheater.ruleLineInterrupted': 'A kiadási szabály ({threshold} + 0 javítás) nem teljesült, de korán leállított. A {n} közül a legjobb megőrzve; az átirat elérhető marad.',
  'critiqueTheater.density.active': 'Csak aktív',
  'critiqueTheater.density.smart': 'Intelligens',
  'critiqueTheater.density.expanded': 'Összes kinyitása',
  'critiqueTheater.interrupt': 'Megszakítás',
  'critiqueTheater.interrupting': 'Megszakítás folyamatban...',
  'critiqueTheater.interruptConfirmTitle': 'Leállítja a zsűrit?',
  'critiqueTheater.interruptConfirmBody': 'Az aktuális kör eddigi legjobb eredménye mentésre kerül.',
  'critiqueTheater.interruptConfirmYes': 'Leállítás',
  'critiqueTheater.interruptConfirmNo': 'Folytatás',
  'critiqueTheater.replay.title': 'Átirat visszajátszása',
  'critiqueTheater.replay.readOnly': 'csak olvasható',
  'critiqueTheater.replay.speeds.1x': '1x',
  'critiqueTheater.replay.speeds.4x': '4x',
  'critiqueTheater.replay.speeds.instant': 'azonnal',
  'critiqueTheater.degraded.title': 'Zsűri offline',
  'critiqueTheater.degraded.retry': 'Újrapróbálás zsűrivel',
  'critiqueTheater.degraded.switchAdapter': 'Adapter váltása',
  'critiqueTheater.degraded.readLog': 'Elemző napló megtekintése',
  'critiqueTheater.shipped.score': 'pontszám',
  'critiqueTheater.shipped.dimsLegend': 'dimenziónkénti pontszámok',
  'critiqueTheater.shipped.export': 'exportálás',
  'critiqueTheater.shipped.rerun': 'Zsűri újrafuttatása',
  'critiqueTheater.interrupted.title': 'Megszakítva',
  'critiqueTheater.interrupted.resume': 'Folytatás',
  'critiqueTheater.interrupted.shipAsIs': 'Kiadás így',
  'critiqueTheater.interrupted.reBrief': 'Elvetés, újra briefing',
  'critiqueTheater.panelist.designer': 'Tervező',
  'critiqueTheater.panelist.critic': 'Kritikus',
